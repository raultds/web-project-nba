...
<<<<<<< HEAD
from NBAstats.views import conference_detail, team_stats, team_detail, player_detail, all_stars_update, my_all_stars, all_all_stars, user_all_stars
=======
from NBAstats.views import conference_detail, team_stats, team_detail, player_detail, all_stars_update, my_all_stars, \
	my_done_all_stars, all_all_stars, user_all_stars, all_stars_delete
...
<<<<<<< HEAD
=======
	path('myallstars/delete', all_stars_delete.as_view(), name='my_all_stars_delete'),
